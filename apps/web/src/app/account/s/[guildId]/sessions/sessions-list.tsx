...
interface ScopedSessionsListProps {
  sessions: Session[];
  campaigns: Campaign[];
...
export function ScopedSessionsList({
  sessions,
  campaigns,
  summariesBySession,
  guildId,
  guildName,
}: ScopedSessionsListProps) {
  ...
  return (
    <>
      ...
      >
        <div>
          <div className="t-eyebrow">{guildName} · sessions</div>
          ...
          {filtered.map((s) => {
            ...
            return (
              <Link
                ...
                href={
                  isLive && s.campaignId
                    ? `/account/s/${guildId}/campaigns/${s.campaignId}/live`
                    : `/account/s/${guildId}/sessions/${s.id}`
                }
